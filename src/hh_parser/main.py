...
def main():
    ...
    try:
        ...
        stats = vacancy_manager.search_and_collect_vacancies(keywords, max_vacancies_per_keyword=5)
        ...
        print(f"Вакансий с зарплатой выше средней: {db_stats.get('high_salary_vacancies_count', 0)}")
